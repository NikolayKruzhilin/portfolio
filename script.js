...
const translations = {
    ru: {
        ...
        cv_exp_desc: "<p><strong>Продуктовый менеджер, Zhejiang Hongji New Energy Technology Company (май 2023 – июнь 2025)</strong><br> Руководил разработкой и запуском продукта AIC thermal coating. Проводил маркетинговые исследования, включая анализ конкурентов и сегментацию рынка; формировал стратегию продукта на основе unit economics, расчетов ARPU, LTV и CAC. Координировал работу с международными партнёрами, оптимизировал воронку продаж и проводил A/B-тестирование для повышения конверсии. Анализировал метрики ROI и churn rate для корректировки стратегии, что привело к росту доходов от продукта.</p> <p><strong>Менеджер по академическим продуктам, i2 International Education Center(центр дополнительного образования, EdTech продукт), Guangxi (октябрь 2021 – март 2023)</strong><br> Разработал и внедрил академические программы для 88 кампусов в 17 городах, включая создание PBL-активностей и сотрудничество с Trinity College London. Обучал более 40 иностранных преподавателей. Работал над мобильным приложением: переводил экраны интерфейса, проводил A/B-тестирование, адаптировал контент, внедрял новые фичи и управлял бэклогом. Организовывал тренинги для учителей и родителей по использованию приложения. Повысил метрики DAU/MAU за счет внедрения инсентивов, геймификации процесса и системы наград, что увеличило вовлеченность участников.</p> <p><strong>Менеджер по продуктовому маркетингу, Shenzhen Yangcai Information Consulting Co., Ltd. (медиа-агентство) (сентябрь 2018 – май 2021)</strong><br> Управлял цифровыми маркетинговыми кампаниями, стратегиями на платформах Amazon, Instagram и Xiaohongshu (RED). Руководил межфункциональными командами по копирайтингу, переводу, мультимедийному производству (фото, видео) и SEO-оптимизации. Разрабатывал лендинги для китайских компаний, мобильные приложения и стратегии запуска продуктов на западном рынке. Проводил A/B-тестирование, работал с инструментами Figma и Miro для UI/UX-дизайна, применял методологии SCRUM и RICE для приоритизации задач. Помогал с локализацией контента, переводами и анализом рынка для повышения эффективности кампаний.</p> <p><strong>Менеджер по снабжению, Мескаль (2014 – 2018)</strong><br> Вёл переговоры с поставщиками, осуществлял контроль качества, обработку заказов и логистику поставок. Организовывал визиты на фабрики и поддерживал связи с поставщиками в России и за рубежом.</p> <p><strong>Фриланс‑проекты</strong>: Маркетинг и фотография для BMW, Tracy’s Dog, Donner.</p>",
